        ...
        >
          ...
          <div class="pro-paywall-value">
            ...
            <div class="pro-feature-table" role="table" aria-label="Solvely Pro feature comparison">
              ...
              <div v-for="feature in ['Unlimited exam predictions', 'Full mock exams with solutions', 'Unlimited flashcards, quizzes', 'Unlimited homework solves', 'Unlimited AI live notes']" :key="feature" class="pro-feature-row" role="row">
