            ...
            <div v-else-if="resultView === 'score'" class="score-report-view">
              ...
              <section class="report-performance-details">
                ...
                <article class="report-confidence-model" aria-labelledby="reportConfidenceTitle">
                  <header class="report-confidence-head"><div><h4 id="reportConfidenceTitle">Topic performance matrix</h4><p>Each dot represents a tested topic. Its position shows how its accuracy and average response time compare with the section averages. Hover over or focus a dot to view details.</p></div><div class="report-confidence-axes" aria-hidden="true"><span>↑ Accuracy</span><span>Time →</span></div></header>
                  <div class="report-confidence-grid">
                    <section v-for="section in resultReport.sections" :key="`confidence-${section.sectionId}`" class="report-confidence-column">
                      ...
                      <div class="report-confidence-chart" role="group" :aria-label="`${section.sectionTitle} topic confidence quadrant by accuracy and average response time`">
                        <span class="report-quad-label proficient">Proficient</span><span class="report-quad-label inefficient">Inefficient</span><span class="report-quad-label careless">Rushed</span><span class="report-quad-label struggling">Struggling</span>
