      ...
      <section v-else class="course-workspace" aria-labelledby="courseWorkspaceTitle">
        ...
        <div class="course-package-panel" role="tabpanel" aria-live="polite">
          <div v-if="activeTab === 'overview'" class="course-overview-waterfall">
            ...
            <section class="course-overview-status-list" aria-label="SAT preparation status">
              <button class="course-overview-status-row" type="button" @click="startMockExam(1)"><span class="course-overview-status-label">Mock Exam</span><strong>14 / 54</strong><p>Attempt in progress · answers saved</p><em>Continue exam →</em></button>
              <button class="course-overview-status-row" type="button" @click="selectTab('results')"><span class="course-overview-status-label">Latest score</span><strong>1280<small>/1600</small></strong><p>70th percentile · completed Aug 21</p><em>View report →</em></button>
              <button class="course-overview-status-row" type="button" @click="selectTab('study')"><span class="course-overview-status-label">Study Plan</span><strong>18%</strong><p>3 of 100+ topics in progress</p><em>Open plan →</em></button>
              <button class="course-overview-status-row" type="button" @click="selectTab('results')"><span class="course-overview-status-label">Weak topics</span><strong>3</strong><p>Prioritized by recent performance and exam importance</p><em>Start improving →</em></button>
            </section>
          </div>
